      ...
      >
        <div className="flex flex-col p-6 md:flex-row md:p-10">
          <div className="flex w-full flex-col items-start justify-center md:w-[60%]">
            ...
            <button className="mt-6 flex  items-center justify-center rounded-full bg-[#007AFF] py-4 px-8 text-xl text-white transition delay-100 duration-200 ease-in-out hover:bg-[#1d1d1f] hover:text-white">
              Book a Demo
            </button>
          </div>
